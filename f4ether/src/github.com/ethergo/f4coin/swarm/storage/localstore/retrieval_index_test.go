...
//
// # go test -benchmem -run=none github.com/ethergo/f4coin/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: github.com/ethergo/f4coin/swarm/storage/localstore
...
//
// go test -benchmem -run=none github.com/ethergo/f4coin/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: github.com/ethergo/f4coin/swarm/storage/localstore
