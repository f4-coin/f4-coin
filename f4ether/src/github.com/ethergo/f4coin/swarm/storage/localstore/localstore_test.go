...
import (
	...
	ch "github.com/ethergo/f4coin/swarm/chunk"
	"github.com/ethergo/f4coin/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/ethergo/f4coin/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
