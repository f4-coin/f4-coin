...
import (
	...
	ethereum "github.com/ethergo/f4coin"
...
//	fsHeaderContCheck      = 60 * time.Second // Time interval to check for header continuations during state download
...
func (d *Downloader) fetchHeaders(p *peerConnection, from uint64, pivot uint64) error {
	p.log.Warn("Directing header downloads", "origin", from)
