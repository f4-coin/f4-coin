...
import (
	...
	"github.com/ethergo/f4coin/cmd/utils"
	"github.com/ethergo/f4coin/common"
	"github.com/ethergo/f4coin/console"
	"github.com/ethergo/f4coin/crypto"
	"github.com/ethergo/f4coin/internal/debug"
	...
	"github.com/ethergo/f4coin/swarm"
	bzzapi "github.com/ethergo/f4coin/swarm/api"
	swarmmetrics "github.com/ethergo/f4coin/swarm/metrics"
	"github.com/ethergo/f4coin/swarm/storage/mock"
	mockrpc "github.com/ethergo/f4coin/swarm/storage/mock/rpc"
	"github.com/ethergo/f4coin/swarm/tracing"
	sv "github.com/ethergo/f4coin/swarm/version"
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The f4coin Authors"
