...
import (
	...
	"github.com/ethergo/f4coin/trie"
	"io"
	"math/big"
	"os"
	"path/filepath"
	...
	"github.com/ethergo/f4coin/common/math"
...
//	alloc[common.BytesToAddress(params.MasterndeContractAddress.Bytes())] = masternodeContractAccount(params.TestnetMasternodes)
	alloc[common.HexToAddress("0x842df4dc581b4a1b57c4d2587a547d6014ee480d")] = GenesisAccount{
//		Balance: new(big.Int).Mul(big.NewInt(1e+15), big.NewInt(1e+15)),
		Balance: new(big.Int).Mul(big.NewInt(1e+18), big.NewInt(1e+8)),
	}
...
func masternodeContractAccount(masternodes []string) GenesisAccount {
	addresses := []common.Address{
		common.HexToAddress("0x435f57f9ba0133e5c005eac4f493abe0709aeca6"),
	}
