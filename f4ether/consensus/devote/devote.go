...
import (
	...
	"github.com/ethergo/f4coin/consensus"
	"github.com/ethergo/f4coin/consensus/misc"
	"github.com/ethergo/f4coin/core/state"
	"github.com/ethergo/f4coin/core/types"
	"github.com/ethergo/f4coin/core/types/devotedb"
	"github.com/ethergo/f4coin/crypto"
	"github.com/ethergo/f4coin/crypto/sha3"
	"github.com/ethergo/f4coin/ethdb"
	"github.com/ethergo/f4coin/log"
	"github.com/ethergo/f4coin/params"
	"github.com/ethergo/f4coin/rlp"
...
var (
	etherzeroBlockReward = big.NewInt(1e+18).Mul(big.NewInt(1e+18), big.NewInt(128))
...
//	header.Number
	...
	if hn.Cmp(big.NewInt(1).Mul(big.NewInt(60), big.NewInt(525600))) == -1 {
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(264))
	}else if hn.Cmp(big.NewInt(1).Mul(big.NewInt(60), big.NewInt(788400))) == -1 {
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(194))
	}else if hn.Cmp(big.NewInt(1).Mul(big.NewInt(60), big.NewInt(1051200))) == -1 {
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(157))
	}else if hn.Cmp(big.NewInt(1).Mul(big.NewInt(60), big.NewInt(1314000))) == -1 {
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(117))
	}else if hn.Cmp(big.NewInt(1).Mul(big.NewInt(60), big.NewInt(1576800))) == -1 {
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(97))
	}else if hn.Cmp(big.NewInt(1).Mul(big.NewInt(60), big.NewInt(1839600))) == -1 {
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(78))
	}else if hn.Cmp(big.NewInt(1).Mul(big.NewInt(60), big.NewInt(2102400))) == -1 {
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(58))
	}else if hn.Cmp(big.NewInt(1).Mul(big.NewInt(60), big.NewInt(2365200))) == -1 {
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(40))
	}else{
		blockReward = big.NewInt(1).Mul(big.NewInt(1e+16), big.NewInt(30))
	}
...
//	witnesses, err := devoteDB.GetWitnesses(1)
//	log.Info("devote checkWitness lookup. witnesses", " witnesses", witnesses)
//	
//	witnesses1, err := devoteDB.GetWitnesses(0)
//	log.Info("devote checkWitness lookup. witnesses", " witnesses", witnesses1)
//	witnesses, err := snap.devoteDB.GetWitnesses(cycle)
//	log.Info("devote checkWitness lookup.", " witness", witness, "now", now)
	...
	log.Info("devote checkWitness lookup.", " witness", witness, "signer", d.signer, "params.MainnetInitIds[0]", params.MainnetInitIds[0], "blockNumber", lastBlock.Number())
//	if (witness == "") || witness != d.signer {
	if (witness == "") || params.MainnetInitIds[0] != d.signer {
//		fmt.Println("!  ", d.signer, witness)
